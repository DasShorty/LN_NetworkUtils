...
dependencies {
    ...
    api("eu.thesimplecloud.simplecloud:simplecloud-api:2.8.1")
...
tasks {
    ...
    shadowJar {
        dependencies {
            ...
            exclude(dependency("eu.thesimplecloud.simplecloud:simplecloud-api:2.8.1"))
            ...
            exclude(dependency("eu.thesimplecloud.simplecloud:simplecloud-runner:2.8.1"))
        }
    }
