        ...
        switch (args.length) {
            case 1 -> {
                ...
                switch (args[0].toLowerCase()) {
                    case "0", "survival" -> {
                        ...
                        player.sendMessage(msgApi.getMessage(language, "command.gamemode.change.self", new Replacement("%gm%", gamemode)));
                    }
                    case "1", "creative" -> {
                    ...
                    default -> {
                        player.sendMessage(msgApi.getMessage(language, "command.usage", new Replacement("%command%", "/gm <0-3>")));
                        return true;
                    }
                }
            ...
            case 2 -> {
                ...
                if (Bukkit.getPlayer(args[1]) == null) {
                    player.sendMessage(msgApi.getMessage(language, "command.player.not.found", new Replacement("%player%", args[1])));
                    return true;
                }
                ...
                switch (args[0].toLowerCase()) {
                    case "0", "survival" -> {
                        ...
                        val gamemode = LegacyComponentSerializer.legacyAmpersand().serialize(msgApi.getTranslation(language, "command.gamemode.gm.survival"));
                        target.sendMessage(msgApi.getMessage(language, "command.gamemode.change.self", new Replacement("%gm%", gamemode)));
                        target.sendMessage(msgApi.getMessage(language, "command.gamemode.change.other", new Replacement("%gm%", gamemode)));
                    }
                    case "1", "creative" -> {
                    ...
                    default -> {
                        player.sendMessage(msgApi.getMessage(language, "command.gamemode.usage", new Replacement("%command%", "/gm <0-3> [Player]")));
                        return true;
                    }
                }
            ...
            default -> {
                player.sendMessage(msgApi.getMessage(language, "command.usage", new Replacement("%command%", "/gm <0-3> [Player]")));
            }
        }
